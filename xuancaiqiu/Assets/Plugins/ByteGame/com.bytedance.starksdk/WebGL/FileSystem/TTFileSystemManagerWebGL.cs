    ...
    public class TTFileSystemManagerWebGL : TTFileSystemManager
    {
        ...
        public override void WriteFile(WriteFileParam param)
        {
            StarkWriteBinFile(
                ...
                param.data,
                param.data.Length,
                TTCallbackHandler.Add(param.success),
                TTCallbackHandler.Add(param.fail)
            );
        }
        ...
        {
            StarkAccessFile(FixFilePath(param.path), TTCallbackHandler.Add(param.success),
                TTCallbackHandler.Add(param.fail));
        }
        ...
        {
            StarkUnlink(FixFilePath(param.filePath), TTCallbackHandler.Add(param.success),
                TTCallbackHandler.Add(param.fail));
        }
        ...
        {
            StarkMkdir(FixFilePath(param.dirPath), param.recursive, TTCallbackHandler.Add(param.success),
                TTCallbackHandler.Add(param.fail));
        }
        ...
        {
            StarkRmdir(FixFilePath(param.dirPath), param.recursive, TTCallbackHandler.Add(param.success),
                TTCallbackHandler.Add(param.fail));
        }
